...
export class SignupComponent implements OnInit {
  ...
  constructor(private toastr: ToastrService, private http:HttpClient, private service:RiyaService, private formbuilder:FormBuilder) {
    // this.signupForm = this.formbuilder.group({
    //   Riya:["",[Validators.required, Validators.email]],
    //   Riya:["",[Validators.required,Validators.name]],
